...
def download(request, id):
	...
	return render(request, "search_download/download.html", info)
...
def search_results(request):
	...
	if request.method == "POST":
		...
		return render(request, 'search_download/search_result.html', context)
	return render(request, "search_download/search_result.html")
...
def history(request):
	...
	return render(request, "search_download/history.html", context)
